...
// criano e chamado 
  ...
  showRank() {
    swal({
      title: `Incrível!${"\n"}Rank${"\n"}${player.rank}`,
      text: "Excelente! Você foi o vencedor !",
      imageUrl:
        "https://cdn.icon-icons.com/icons2/1952/PNG/512/iconfinder-medal-award-trophy-premium-win-first-place-18-4640283_122695.png",
      imageSize: "300x150",
